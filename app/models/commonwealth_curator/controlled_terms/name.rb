...
module CommonwealthCurator
  class ControlledTerms::Name < ControlledTerms::Nomenclature
    ...
    belongs_to :authority, inverse_of: :names, class_name: 'CommonwealthCurator::ControlledTerms::Authority', optional: true
    ...
    has_many :physical_locations_of, inverse_of: :physical_location, class_name: 'CommonwealthCurator::Metastreams::Descriptive', foreign_key: :physical_location_id
