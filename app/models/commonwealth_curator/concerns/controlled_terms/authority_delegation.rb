...
module CommonwealthCurator
  module AuthorityDelegation
    ...
    included do
      ...
      validates :authority_id, uniqueness: { scope: '(term_data-> "id_from_auth")' }, allow_nil: true }, if: Proc.new {|n| n.authority.present?  && n.id_from_auth.present? } #We want these to be unique if the authority is present
