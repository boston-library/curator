...
module Curator
  class ControlledTerms::Name < ControlledTerms::Nomenclature
    ...
    has_many :desc_name_roles, inverse_of: :name, class_name: Curator.mappings.desc_name_role_class_name, foreign_key: :name_id
    has_many :physical_locations_of, inverse_of: :physical_location, class_name: Curator.metastreams.descriptive_class_name, foreign_key: :physical_location_id
