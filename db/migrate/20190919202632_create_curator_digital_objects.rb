...
class CreateCuratorDigitalObjects < ActiveRecord::Migration[5.2]
  def change
    ...
    add_belongs_to :curator_digital_objects, :contained_by, index: { using: :btree, name: 'idx_digital_objects_on_contained_by' }, foreign_key: { to_table: :curator_digital_objects, on_delete: :cascade }
