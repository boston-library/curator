...
class CreateCuratorDigitalObjects < ActiveRecord::Migration[5.2]
  def change
    ...
    add_belongs_to :curator_metastreams_descriptives, :digital_object, index: { unique: true, using: :btree, name: 'unique_idx_meta_desc_on_digital_object' }, foreign_key: { to_table: :curator_digital_objects, on_delete: :cascade }, null: false
