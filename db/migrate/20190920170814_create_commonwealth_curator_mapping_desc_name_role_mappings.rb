class CreateCommonwealthCuratorMappingDescNameRoleMappings < ActiveRecord::Migration[5.2]
  def change
    create_table :curator_mapping_desc_name_role_mappings do |t|
      ...
      t.belongs_to :name, index: { using: :btree }, foreign_key: { to_table: :curator_controlled_terms_nomenclatures }, null: false
      t.belongs_to :role, index: { using: :btree }, foreign_key: { to_table: :curator_controlled_terms_nomenclatures }, null: false
