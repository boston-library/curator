...
class CreateCuratorMetastreamsDescriptives < ActiveRecord::Migration[5.2]
  def change
    reversible do |dir|
      dir.up do
        create_enum :metastreams_descriptives_digital_origin, ['born_digital', 'reformatted_digital', 'digitized_microfilm', 'digitized_other_analog']
        create_table :curator_metastreams_descriptives do |t|
          ...
          t.enum :digital_origin, enum_name: :metastreams_descriptives_digital_origin, default: 'reformatted_digital'
      ...
      dir.down do
        drop_table :curator_metastreams_descriptives
        drop_enum :metastreams_descriptives_digital_origin
      end
    end
  end
end
