    ...
    reversible do |dir|
      dir.up do
        ...
        create_table 'curator.metastreams_workflows' do |t|
          ...
          t.enum :publishing_state, enum_name: 'curator.metastreams_workflow_publishing_state', index: { using: :btree, name: 'idx_meta_workflow_on_publsihing_state' }, null: true
          t.enum :processing_state, enum_name: 'curator.metastreams_workflow_processing_state', index: { using: :btree, name: 'idx_meta_workflow_on_processing_state' }, null: true
