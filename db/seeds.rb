...
authorities_url = "#{ENV['AUTHORITY_API_URL']}/bpldc/authorities"
...
terms_for_seed.each do |term_for_seed|
  terms_url = "#{ENV['AUTHORITY_API_URL']}/bpldc/#{term_for_seed}"
...
licenses_url = "#{ENV['AUTHORITY_API_URL']}/bpldc/licenses"
