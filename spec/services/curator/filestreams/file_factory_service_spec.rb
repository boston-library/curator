...
RSpec.describe Curator::Filestreams::FileFactoryService do
  json_fixture = File.join(Curator::Engine.root.join('spec', 'fixtures', 'files', 'file.json'))
  object_json = JSON.parse(File.read(json_fixture)).fetch('file', {})
