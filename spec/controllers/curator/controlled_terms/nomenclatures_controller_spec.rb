...
module Curator
  RSpec.describe ControlledTerms::NomenclaturesController, type: :controller do
    ...
    describe "GET #index" do
      it "returns a success response" do
        nomenclature = ControlledTerms::Nomenclature.create! valid_attributes
    ...
    describe "GET #show" do
      it "returns a success response" do
        nomenclature = ControlledTerms::Nomenclature.create! valid_attributes
        get :show, params: { id: nomenclature.to_param }, session: valid_session
        expect(response).to be_successful
      end
    end
    ...
    describe "POST #create" do
      context "with valid params" do
        it "creates a new ControlledTerms::Nomenclature" do
          expect {
            post :create, params: { controlled_terms_nomenclature: valid_attributes }, session: valid_session
          }.to change(ControlledTerms::Nomenclature, :count).by(1)
        end
        ...
        it "renders a JSON response with the new controlled_terms_nomenclature" do
          ...
          expect(response.location).to eq(controlled_terms_nomenclature_url(ControlledTerms::Nomenclature.last))
        end
      end
    ...
    describe "DELETE #destroy" do
      it "destroys the requested controlled_terms_nomenclature" do
        nomenclature = ControlledTerms::Nomenclature.create! valid_attributes
        expect {
          delete :destroy, params: { id: nomenclature.to_param }, session: valid_session
        }.to change(ControlledTerms::Nomenclature, :count).by(-1)
      end
    end
  end
