...
RSpec.describe Curator::FieldSets::Note, type: :model do
  ...
  describe 'attributes' do
    ...
    describe 'validations' do
      it { is_expected.to validate_inclusion_of(:type).
                          in_array(Curator::FieldSets::NOTE_TYPES) }
    end
    ...
    describe 'attr_json settings' do
      ...
      it 'expects the attributes to have types that match values' do
        ...
        expect(subject.type).to be_an_instance_of(String).and satisfy { |type| Curator::FieldSets::NOTE_TYPES.include?(type) }
      end
    end
  end
end
