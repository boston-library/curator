...
RSpec.describe Curator::DescriptiveFieldSets::ReferencedBy, type: :model do
  subject { create(:curator_descriptives_referenced_by) }
  ...
  describe 'attributes' do
    ...
    describe 'attr_json settings' do
      let(:field_types) { %i(label url).map { |field| described_class.attr_json_registry.fetch(field, nil)&.type } }
