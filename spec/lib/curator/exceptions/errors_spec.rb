...
RSpec.describe Curator::Exceptions do
  ...
  describe 'remote_service_errors' do
    %i(SolrUnavailable AuthorityApiUnavailable ArkManagerApiUnavailable IIIFServerUnavailable
       IIIFManifestEndpointUnavailable RemoteServiceError AllmapsAnnotationsUnavailable).each do |remote_error_const|
